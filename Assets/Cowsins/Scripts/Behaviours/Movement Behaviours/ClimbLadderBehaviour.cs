...
public class ClimbLadderBehaviour
{
    ...
    public void Exit()
    {
        ...
        rb.useGravity = true;
        playerEvents.Events.OnClimbStop?.Invoke(true);
    }

    public bool CanExecute()
    {
        return playerControl.IsControllable && playerControl.IsMovementControllable && DetectLadders();
    }
    ...
    public bool DetectLadders()
    {
        ...
        if (isGrounded && ladderAhead)
        {
            ...
            if (inputManager.Y > 0.01f)
            {
                ...
                playerEvents.Events.OnClimbStart?.Invoke(true);
                return true;
            }
            return false;
        }
