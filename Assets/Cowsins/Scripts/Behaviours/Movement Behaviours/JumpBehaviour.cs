...
public class JumpBehaviour
{
    ...
    public void Enter()
    {
        ...
        // Store velocity
        Vector3 velocity = CowsinsUtilities.GetLinearVelocity(rb);
        // Reset Y velocity before jumping
        velocity.y = 0f;
        CowsinsUtilities.SetLinearVelocity(rb, velocity);
    ...
    public bool CanExecute()
    {
        ...
        return playerSettings.allowJump
            ...
            && playerControl.IsMovementControllable
            && isJumpAvailable
    ...
    private void Jump()
    {
        ...
        {
            if (Vector3.Dot(CowsinsUtilities.GetLinearVelocity(rb), new Vector3(inputX, 0, inputY)) > .5f)
                CowsinsUtilities.SetLinearVelocity(rb, CowsinsUtilities.GetLinearVelocity(rb) / 2f);
