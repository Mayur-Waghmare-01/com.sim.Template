...
public class WallBounceBehaviour
{
    ...
    public void Enter() 
    {
        ...
        CowsinsUtilities.SetLinearVelocity(rb, Vector3.zero);
    ...
    public bool CanExecute() => inputManager.Jumping && wallOpposite && playerSettings.canWallBounce && playerControl.IsControllable && playerControl.IsMovementControllable && playerEvents.Events.InvokeCanWallBounce();
}
