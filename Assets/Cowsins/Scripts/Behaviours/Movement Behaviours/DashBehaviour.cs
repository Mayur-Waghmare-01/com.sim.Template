...
public class DashBehaviour 
{
    ...
    public void Tick() 
    {
        ...
        vel.y = 0;
        CowsinsUtilities.SetLinearVelocity(rb, vel);
    ...
    {
        return playerControl.IsControllable && playerControl.IsMovementControllable && playerSettings.canDash && (playerSettings.infiniteDashes || currentDashes > 0 && !playerSettings.infiniteDashes);
    }
