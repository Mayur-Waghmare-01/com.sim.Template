...
public class StaminaBehaviour
{
    ...
    public void Tick()
    {
        ...
        float horizontalSpeed = new Vector3(CowsinsUtilities.GetLinearVelocity(rb).x, 0f, CowsinsUtilities.GetLinearVelocity(rb).z).magnitude;
        ...
        {
            playerEvents.Events.OnStaminaChanged?.Invoke(currentStamina, playerSettings.maxStamina);
