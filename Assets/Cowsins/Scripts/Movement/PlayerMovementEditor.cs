            ...
            if (currentTab >= 0 || currentTab < tabs.Length)
            {
                switch (tabs[currentTab])
                {
                    ...
                    case "Camera":
                        ...
                        EditorGUILayout.PropertyField(playerSettings.FindPropertyRelative("invertYSensitivity"));
                        ...
                        EditorGUILayout.PropertyField(playerSettings.FindPropertyRelative("invertYControllerSensitivity"));
