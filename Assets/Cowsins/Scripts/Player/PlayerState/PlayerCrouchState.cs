...
namespace cowsins
{
    public class PlayerCrouchState : PlayerBaseState
    {
        ...
        public sealed override void UpdateState()
        {
            ...
            if (playerControlProvider.CameraControllable)
        ...
        {
            if (inputManager.Jumping && playerMovement.playerSettings.canJumpWhileCrouching && playerMovement.jumpBehaviour.CanExecute())
