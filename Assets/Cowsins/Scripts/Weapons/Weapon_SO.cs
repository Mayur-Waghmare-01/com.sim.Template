...
namespace cowsins
{
    ...
    [CreateAssetMenu(fileName = "NewWeapon", menuName = "COWSINS/FPS ENGINE/New Weapon", order = 1)]
    public class Weapon_SO : Item_SO
    {
        ...
        [Tooltip("In order to shoot, you need to have a 100% progress value. Define how fast you want to reach 100% here (in percentage points per second).")] public float holdProgressSpeed;
