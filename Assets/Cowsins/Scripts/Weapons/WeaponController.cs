...
namespace cowsins
{
    ...
    public class WeaponController : MonoBehaviour, IWeaponReferenceProvider, IWeaponBehaviourProvider, IWeaponRecoilProvider, IWeaponEventsProvider
    {
        ...
        public Transform WeaponHolder => settings.weaponHolder;

        public bool IsMeleeAvailable { get; set; }
        public bool IsAiming { get; set; }
        public bool IsShooting { get; set; }
        public bool IsReloading { get; set; }
        public bool IsOverheated => Id != null && (Id.heatRatio >= 1 || Id.isOverheated);
        ...
        private void InitializeBehaviours()
        {
            ...
            attachmentsSystem = new AttachmentsSystem(weaponContext);
        ...
        private void HandleCrosshairEnemySpot()
        {
            ...
            {
                if(hit.collider.CompareTag("Enemy") || hit.collider.CompareTag(CowsinsUtilities.CRITICAL_TAG))
                {
