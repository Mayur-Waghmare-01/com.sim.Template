    ...
    namespace cowsins
    {
        ...
        public class TitleDrawer : PropertyDrawer
        {
            ...
            public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
            {
                ...
                Rect propertyRect = new Rect(position.x, dividerRect.yMax + 10, position.width, EditorGUIUtility.singleLineHeight);
            ...
            {
                return ( EditorGUIUtility.singleLineHeight + propertySeparation ) * 2.1f + 11 + ((TitleAttribute)attribute).upMargin;
            }
        }
    }
