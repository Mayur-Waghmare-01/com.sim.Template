...
namespace cowsins
{
    public partial class Trigger : Identifiable
    {
        ...
        { 
            if (!onlyTriggerPlayer) return true;
            if (other.CompareTag("Player")) return true;
            
            if (other.CompareTag("Enemy") && other.GetComponentInParent<PlayerStats>() != null) return true;
            
            return false;
        }

        // Resets the triggered guard so this trigger can fire again
        public void ResetTriggered() => triggered = false;
    }
}
