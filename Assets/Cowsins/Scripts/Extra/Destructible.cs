...
namespace cowsins
{
    ...
    public class Destructible : Identifiable, IDamageable
    {
        ...
        public AudioClip DestroyedSFX => destroyedSFX;

        public float Health => health;
        public float Shield => 0f;
        public bool IsDead => health <= 0f;
        /// <summary>Max health. Exposed for network sync components.</summary>
        public float MaxHealth => maxHealth;
        public Action OnWillDie;
        ...
        {
            OnWillDie?.Invoke();
            if (lootInside != null) SpawnService.Spawn(lootInside, transform.position, Quaternion.identity);
